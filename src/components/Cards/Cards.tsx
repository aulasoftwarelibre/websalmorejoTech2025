        ...
        <div>
            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-4">
                        <Card description="Estudiando informática en la UCO" photo={CarlosTorres} backphoto={CarlosTorresOP}> Carlos Torres Jiménez </Card>
                    </div>
                    <div className="col-md-4">
                        <Card description="Estudiante de 1°Ingeniería Informática."  lklink="https://www.linkedin.com/in/david-s%C3%A1nchez-palomino-a06671322?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" ghlink="https://github.com/davidI9" photo={DavidSanchez}  backphoto={DavidSanchezOP}> David Sánchez Palomino </Card>
                    </div>
                    <div className="col-md-4">
                        <Card description="Estudiante de ingeniería informática de la UCO" photo={Roxana} backphoto={RoxanaOP}> Roxana Ortiz Mellado</Card>
                    </div>
                    <div className="col-md-4">
            ...
            <div className="container">
                <div className="row justify-content-center">
                    ...
                    <div className="col-md-4">
                        <Card description="" photo={Juanan} backphoto={JuananOP} twlink="https://x.com/__juaneljulaint" lklink='https://www.linkedin.com/in/juan-mellado-02056a352?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app' ghlink='https://github.com/butifarraprogramadora3000'> Arturo Vicente Perez</Card>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-4">
                            <Card description="Funciono con código: 
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-4">
                            <Card description="2ndo de Ingeniería Informática en la UCO
                                Subdelegado de las relaciones externas del Aula de Software Libre
                                Distribuidor oficial de memes del Salmorejo" photo={Jaime} backphoto={JaimeOP}  twlink='https://x.com/JaimeH_05' lklink='https://www.linkedin.com/in/jaime-hern%C3%A1ndez-p%C3%A9rez-731284352/' ghlink='https://github.com/JaimeHP05' > Jaime Hernández Pérez  </Card>
                        </div>
                        <div className="col-md-4">
                            <Card description="Ojala el meme de Cristiano y Messi hubiese sido idea mía" photo={Minghan} backphoto={MinghanOP} > Minghan Wang  </Card>
                        </div>
                    </div>
                </div>
            </div>
            <h3 className={styles.group}>Gestión</h3>
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-4">
                            <Card description="Estudiante de 4 de ingeniería informática apasionado del desarrollo de software con muchas ganas de aprender" photo={Alvaro} backphoto={AlvaroOP}  ghlink='https://github.com/alvaroserrano09' lklink='https://www.linkedin.com/in/%C3%A1lvaro-serrano-lop%C3%A9z-98058125a/'> Álvaro Serrano Lopéz  </Card>
                        </div>
                        <div className="col-md-4">
