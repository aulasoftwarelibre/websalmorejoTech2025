...
const Carousel = props => {
  ...
  return /*#__PURE__*/(
    ...
    images.map(({ imgUrl }, index) => /*#__PURE__*/
    React.createElement("div", {
      className: "card",
      key: index,
      onClick: () => setActive(index),
      style: getStyle(index) }, /*#__PURE__*/

    React.createElement("img", { src: imgUrl })))), /*#__PURE__*/



    React.createElement("div", { className: "rects" },
    images.map((value, index) => /*#__PURE__*/
    React.createElement("div", {
      key: index,
...
React.createElement(Carousel, { images: images }),
